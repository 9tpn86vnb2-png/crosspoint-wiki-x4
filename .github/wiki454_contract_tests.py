...
parser = text('lib/Epub/Epub/parsers/ChapterHtmlSlimParser.cpp')
page = text('lib/Epub/Epub/Page.h')
...
check('manual Mark as Finished retained', 'MARK_AS_FINISHED' in epub and 'FINISHED_BOOKS.addBook' in epub)
