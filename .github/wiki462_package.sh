...
for old in [
    ...
    'crosspoint-1.6.0-wiki-4.5.4-x4-UNTESTED.bin',
    'crosspoint-1.6.0-wiki-4.6.0-x4-UNTESTED.bin',
    'crosspoint-1.6.0-wiki-4.6.1-x4-UNTESTED.bin',
]:
    s = s.replace(old, 'crosspoint-1.6.0-wiki-4.6.2-x4-UNTESTED.bin')
for old in [
    ...
    "UI_VERSION = '1.6.0-wiki-4.5.4'",
    "UI_VERSION = '1.6.0-wiki-4.6.0'",
    "UI_VERSION = '1.6.0-wiki-4.6.1'",
]:
    s = s.replace(old, "UI_VERSION = '1.6.0-wiki-4.6.2'")
...
extras = [
    ...
    '.github/wiki462_apply.py',
    '.github/wiki462_contract_tests.py',
    ...
    'src/activities/wiki/WikiActivity.cpp',
    'src/activities/wiki/WikiActivity.h',
...
if needle not in s:
    raise SystemExit('4.6.2 package: source manifest anchor not found')
s = s.replace(needle, replacement, 1)
if "NAME = 'crosspoint-1.6.0-wiki-4.6.2-x4-UNTESTED.bin'" not in s:
    raise SystemExit('4.6.2 package: artifact name replacement failed')
if "UI_VERSION = '1.6.0-wiki-4.6.2'" not in s:
    raise SystemExit('4.6.2 package: UI version replacement failed')
p.write_text(s)
PY
